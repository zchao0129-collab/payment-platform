...
DELETE FROM t_commission_config WHERE id > 4;    -- 保留初始 4 条返佣配置
...
ALTER TABLE t_commission_config AUTO_INCREMENT = 5;
...
-- ============================================================
INSERT INTO t_merchant (merchant_no, merchant_name, phone, alipay_account, password, salt, referral_code, parent_referral, status, login_lock_until, login_fail_count, created_at, updated_at) VALUES
('M20240101001', '星辰科技有限公司',     '13800010001', 'alipay@xingchen.com',     '$2a$10$7FrlaRYmiSV4zOWCrboX2.84AH1/IpvtLc9XcI85G6zL0H0cqM..W', '', 'REF001', '',        1, NULL,     0, NOW() - INTERVAL 60 DAY, NOW()),
('M20240215001', '银河数码工作室',       '13800010002', 'alipay@yinhe.com',        '$2a$10$7FrlaRYmiSV4zOWCrboX2.84AH1/IpvtLc9XcI85G6zL0H0cqM..W', '', 'REF002', 'REF001',  1, NULL,     0, NOW() - INTERVAL 45 DAY, NOW()),
('M20240320001', '蓝海电商有限公司',     '13800010003', 'alipay@lanhai.com',       '$2a$10$7FrlaRYmiSV4zOWCrboX2.84AH1/IpvtLc9XcI85G6zL0H0cqM..W', '', 'REF003', 'REF002',  2, NOW(),    5, NOW() - INTERVAL 30 DAY, NOW()),
('M20240401001', '云帆支付服务商',       '13800010004', 'alipay@yunfan.com',       '$2a$10$7FrlaRYmiSV4zOWCrboX2.84AH1/IpvtLc9XcI85G6zL0H0cqM..W', '', 'REF004', 'REF001',  1, NULL,     0, NOW() - INTERVAL 20 DAY, NOW()),
('M20240510001', '极光互动娱乐',         '13800010005', 'alipay@jiguang.com',      '$2a$10$7FrlaRYmiSV4zOWCrboX2.84AH1/IpvtLc9XcI85G6zL0H0cqM..W', '', 'REF005', '',        1, NULL,     0, NOW() - INTERVAL 15 DAY, NOW()),
('M20240601001', '鼎新财务咨询',         '13800010006', 'alipay@dingxin.com',      '$2a$10$7FrlaRYmiSV4zOWCrboX2.84AH1/IpvtLc9XcI85G6zL0H0cqM..W', '', 'REF006', 'REF005',  1, NULL,     0, NOW() - INTERVAL 10 DAY, NOW()),
('M20240615001', '海川贸易有限公司',     '13800010007', 'alipay@haichuan.com',     '$2a$10$7FrlaRYmiSV4zOWCrboX2.84AH1/IpvtLc9XcI85G6zL0H0cqM..W', '', 'REF007', '',        2, NOW(),    3, NOW() - INTERVAL 7 DAY, NOW()),
('M20240701001', '繁花生活服务平台',     '13800010008', 'alipay@fanhua.com',       '$2a$10$7FrlaRYmiSV4zOWCrboX2.84AH1/IpvtLc9XcI85G6zL0H0cqM..W', '', 'REF008', 'REF006',  1, NULL,     0, NOW() - INTERVAL 5 DAY, NOW()),
('M20240720001', '锐思数据科技',         '13800010009', 'alipay@ruisi.com',        '$2a$10$7FrlaRYmiSV4zOWCrboX2.84AH1/IpvtLc9XcI85G6zL0H0cqM..W', '', 'REF009', 'REF005',  1, NULL,     0, NOW() - INTERVAL 3 DAY, NOW()),
('M20240801001', '天工智能硬件',         '13800010010', 'alipay@tiangong.com',     '$2a$10$7FrlaRYmiSV4zOWCrboX2.84AH1/IpvtLc9XcI85G6zL0H0cqM..W', '', 'REF010', 'REF008',  1, NULL,     0, NOW() - INTERVAL 1 DAY, NOW());

-- ============================================================
-- 2. t_user — 用户表（10条，不含管理员 admin）
...
('merchant01', '13800020001', '$2a$10$7FrlaRYmiSV4zOWCrboX2.84AH1/IpvtLc9XcI85G6zL0H0cqM..W', '', 2, 1,  1, NULL,     0, NOW() - INTERVAL 1 HOUR,  '192.168.1.101', NOW() - INTERVAL 50 DAY, NOW()),
('merchant02', '13800020002', '$2a$10$7FrlaRYmiSV4zOWCrboX2.84AH1/IpvtLc9XcI85G6zL0H0cqM..W', '', 2, 2,  1, NULL,     0, NOW() - INTERVAL 5 HOUR,  '192.168.1.102', NOW() - INTERVAL 40 DAY, NOW())
...
-- ============================================================
INSERT INTO t_order (order_no, merchant_id, merchant_no, product_name, order_amount, order_status, alipay_trade_no, pay_time, callback_time, refund_time, refund_amount, expire_time, fail_reason, qrcode_id, remark, created_at, updated_at) VALUES
('ORD202408010001', 1, 'M20240101001', 'VIP会员年费',              299.00, 1, '',                              NULL,                   NULL,                   NULL,        NULL,          NOW() + INTERVAL 2 HOUR,  '',                            1,  '待支付订单',         NOW() - INTERVAL 10 MIN, NOW()),
('ORD202408010002', 2, 'M20240215001', '数码产品-无线耳机',        159.00, 2, '2024080122001412345678900001',  NOW() - INTERVAL 2 HOUR,  NULL,                   NULL,        NULL,          NOW() + INTERVAL 1 DAY,    '',                            3,  '已支付待回调',       NOW() - INTERVAL 3 HOUR,  NOW() - INTERVAL 2 HOUR),
('ORD202408010003', 4, 'M20240401001', '云服务器月租',             599.00, 3, '2024080122001412345678900002',  NOW() - INTERVAL 5 HOUR,  NOW() - INTERVAL 4 HOUR,  NULL,        NULL,          NOW() + INTERVAL 1 DAY,    '',                            5,  '支付回调已完成',     NOW() - INTERVAL 6 HOUR,  NOW() - INTERVAL 4 HOUR),
('ORD202408010004', 1, 'M20240101001', '企业认证服务费',           99.00,  4, '2024080122001412345678900003',  NOW() - INTERVAL 2 DAY,   NOW() - INTERVAL 2 DAY,   NOW() - INTERVAL 1 DAY, 99.00,        NOW() + INTERVAL 1 DAY,    '客户申请退款',                1,  '全额退款',           NOW() - INTERVAL 3 DAY,    NOW() - INTERVAL 1 DAY),
('ORD202408010005', 5, 'M20240510001', '游戏点卡100元',            100.00, 4, '2024080122001412345678900004',  NOW() - INTERVAL 3 DAY,   NOW() - INTERVAL 3 DAY,   NOW() - INTERVAL 2 DAY, 50.00,        NOW() + INTERVAL 1 DAY,    '部分退款',                    6,  '部分退款50元',       NOW() - INTERVAL 4 DAY,    NOW() - INTERVAL 2 DAY),
('ORD202408010006', 3, 'M20240320001', '电商订单-日用百货',        58.50,  5, '',                              NULL,                   NULL,                   NULL,        NULL,          NOW() - INTERVAL 1 HOUR,  '订单超时自动失效',             4,  '超时失效',           NOW() - INTERVAL 3 HOUR,  NOW() - INTERVAL 1 HOUR),
('ORD202408010007', 7, 'M20240615001', '企业报税服务',             1200.00,6, '',                              NULL,                   NULL,                   NULL,        NULL,          NOW() + INTERVAL 1 DAY,    '支付宝风控拦截',               NULL, '支付被风控拦截',     NOW() - INTERVAL 1 HOUR,  NOW()),
('ORD202408010008', 6, 'M20240601001', '财务软件授权费',           399.00, 3, '2024080122001412345678900005',  NOW() - INTERVAL 6 HOUR,  NOW() - INTERVAL 5 HOUR,  NULL,        NULL,          NOW() + INTERVAL 1 DAY,    '',                            8,  '正常完成',           NOW() - INTERVAL 7 HOUR,  NOW() - INTERVAL 5 HOUR),
('ORD202408010009', 8, 'M20240701001', '生活服务-家政清洁',        200.00, 1, '',                              NULL,                   NULL,                   NULL,        NULL,          NOW() + INTERVAL 4 HOUR,  '',                            9,  '新建待支付',         NOW() - INTERVAL 5 MIN,   NOW()),
('ORD202408010010', 9, 'M20240720001', '数据分析报告定制',         888.00, 2, '2024080122001412345678900006',  NOW() - INTERVAL 1 HOUR,  NULL,                   NULL,        NULL,          NOW() + INTERVAL 2 DAY,    '',                            10, '已支付待回调',       NOW() - INTERVAL 2 HOUR,  NOW() - INTERVAL 1 HOUR);

-- ============================================================
-- 6. t_payment_log — 支付日志表（10条）
--    notify_status: 1-成功, 2-验签失败, 3-业务处理失败
-- ============================================================
INSERT INTO t_payment_log (order_id, order_no, alipay_trade_no, notify_content, notify_status, error_msg, process_time_ms, created_at) VALUES
(2,  'ORD202408010002', '2024080122001412345678900001', '{"trade_no":"2024080122001412345678900001","total_amount":"159.00","trade_status":"TRADE_SUCCESS"}',  1, '',      120, NOW() - INTERVAL 2 HOUR),
(3,  'ORD202408010003', '2024080122001412345678900002', '{"trade_no":"2024080122001412345678900002","total_amount":"599.00","trade_status":"TRADE_SUCCESS"}',  1, '',      95,  NOW() - INTERVAL 5 HOUR),
(4,  'ORD202408010004', '2024080122001412345678900003', '{"trade_no":"2024080122001412345678900003","total_amount":"99.00","trade_status":"TRADE_SUCCESS"}',   1, '',      110, NOW() - INTERVAL 2 DAY),
(5,  'ORD202408010005', '2024080122001412345678900004', '{"trade_no":"2024080122001412345678900004","total_amount":"100.00","trade_status":"TRADE_SUCCESS"}',  1, '',      88,  NOW() - INTERVAL 3 DAY),
(8,  'ORD202408010008', '2024080122001412345678900005', '{"trade_no":"2024080122001412345678900005","total_amount":"399.00","trade_status":"TRADE_SUCCESS"}',  1, '',      102, NOW() - INTERVAL 6 HOUR),
(10, 'ORD202408010010', '2024080122001412345678900006', '{"trade_no":"2024080122001412345678900006","total_amount":"888.00","trade_status":"TRADE_SUCCESS"}',  1, '',      135, NOW() - INTERVAL 1 HOUR),
(6,  'ORD202408010006', '',                              '{"trade_no":"2024080122001412345678900007","total_amount":"58.50","trade_status":"TRADE_CLOSED"}',   1, '',      78,  NOW() - INTERVAL 1 HOUR),
(7,  'ORD202408010007', '',                              '{"trade_no":"2024080122001412345678900008","total_amount":"1200.00"}',                              2, '签名验证失败', 200, NOW()),
(3,  'ORD202408010003', '2024080122001412345678900002', '{"trade_no":"2024080122001412345678900002","total_amount":"599.00","trade_status":"TRADE_SUCCESS"}',  3, '订单状态异常', 150, NOW() - INTERVAL 4 HOUR + INTERVAL 10 MIN),
(9,  'ORD202408010009', '',                              '',                                                                                                  2, '空回调内容', 5,    NOW());
...
('COM202408010008', 1, 1,  'ORD202408010001', 299.00,  0.0065, 1.94,  1, NULL, CURDATE(),           NOW() - INTERVAL 10 MIN, NOW()),
...
('WD202408010005', 6, 'M20240601001', 1200.00, 'alipay@dingxin.com',   2, 10,NOW() - INTERVAL 2 DAY,  '',             'PROOF-005-transfer',             NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 2 DAY),
('WD202408010006', 8, 'M20240701001', 600.00,  'alipay@fanhua.com',    1, NULL, NULL,                   '',             '',                               NOW() - INTERVAL 2 HOUR, NOW()),
('WD202408010007', 9, 'M20240720001', 1500.00, 'alipay@ruisi.com',     3, 10,NOW() - INTERVAL 1 DAY,  '提现金额超过未结算佣金总额', '',                               NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 1 DAY),
...
('WD202408010010', 10,'M20240801001', 250.00,  'alipay@tiangong.com',  1, NULL, NULL,                   '',             '',                               NOW() - INTERVAL 30 MIN, NOW());

-- ============================================================
-- 9. t_referral_relation — 推荐关系表（10条）
--    level: 1-直接下级
-- ============================================================
...
(1, 5,  'M20240510001', 1, NOW() - INTERVAL 15 DAY),
(4, 7,  'M20240615001', 1, NOW() - INTERVAL 7 DAY),
(1, 9,  'M20240720001', 1, NOW() - INTERVAL 3 DAY);

-- ============================================================
-- 10. t_operation_log — 操作日志表（10条）
--     op_type 覆盖: LOGIN/LOGOUT/CREATE_ORDER/AUDIT/CONFIG_UPDATE 等
-- ============================================================
INSERT INTO t_operation_log (user_id, username, op_type, op_target, op_detail, ip, user_agent, created_at) VALUES
(1,  'admin',       'LOGIN',         'SYSTEM',         '管理员登录系统',                     '192.168.0.1',    'Mozilla/5.0 Chrome/120',        NOW() - INTERVAL 10 MIN),
(2,  'merchant01',  'LOGIN',         'SYSTEM',         '商户用户登录',                       '192.168.1.101',  'Mozilla/5.0 Chrome/120',        NOW() - INTERVAL 1 HOUR),
(1,  'admin',       'AUDIT_PASS',    'WD202408010001', '审核通过提现单 WD202408010001，金额 500.00',  '192.168.0.1',    'Mozilla/5.0 Chrome/120',        NOW() - INTERVAL 1 DAY),
(10, 'oper_admin',  'AUDIT_REJECT',  'WD202408010009', '审核驳回提现单: 商户账户已停用',       '192.168.0.1',    'Mozilla/5.0 Firefox/128',       NOW() - INTERVAL 4 HOUR),
(10, 'oper_admin',  'AUDIT_PASS',    'WD202408010005', '审核通过提现单 WD202408010005，金额 1200.00', '192.168.0.1',    'Mozilla/5.0 Firefox/128',       NOW() - INTERVAL 2 DAY),
(1,  'admin',       'CONFIG_UPDATE', 'ALIPAY_CONFIG',  '更新支付宝配置ID=1: 更新证书路径',      '192.168.0.1',    'Mozilla/5.0 Chrome/120',        NOW() - INTERVAL 10 DAY),
(5,  'merchant05',  'CREATE_ORDER',  'ORD202408010005','创建游戏点卡订单，金额100.00',         '192.168.2.5',    'Mozilla/5.0 Safari/17',         NOW() - INTERVAL 4 DAY),
(1,  'admin',       'DISABLE_USER',  'merchant07',     '停用商户用户 merchant07',             '192.168.0.1',    'Mozilla/5.0 Chrome/120',        NOW() - INTERVAL 7 DAY),
(8,  'merchant08',  'LOGOUT',        'SYSTEM',         '用户主动登出',                       '192.168.3.50',   'Mozilla/5.0 Edge/120',          NOW() - INTERVAL 3 HOUR),
(3,  'merchant03',  'LOGIN_FAIL',    'SYSTEM',         '登录失败：密码错误（第3次），账户已锁定',  '10.0.0.1',       'Mozilla/5.0 Chrome/120',        NOW() - INTERVAL 30 DAY);
...
('13800010001', '4592', 1, '192.168.1.101', 0, 0, NOW() + INTERVAL 5 MIN,  NOW() - INTERVAL 1 MIN),
('13800010002', '7831', 2, '192.168.1.102', 1, 0, NOW() + INTERVAL 5 MIN,  NOW() - INTERVAL 2 HOUR),
('13800010003', '1267', 2, '10.0.0.1',      0, 2, NOW() + INTERVAL 5 MIN,  NOW() - INTERVAL 10 MIN),
...
('13800010006', '2148', 2, '172.16.0.10',   0, 1, NOW() + INTERVAL 5 MIN,  NOW() - INTERVAL 5 MIN),
('13800010007', '6703', 1, '10.0.0.99',     0, 0, NOW() + INTERVAL 5 MIN,  NOW() - INTERVAL 2 MIN),
('13800010008', '3056', 3, '192.168.3.50',  1, 0, NOW() - INTERVAL 1 DAY,   NOW() - INTERVAL 3 DAY),
('13800010009', '8514', 2, '172.20.0.8',    0, 0, NOW() + INTERVAL 5 MIN,  NOW() - INTERVAL 3 MIN),
...
('CAPTCHA-TKT-001-A1B2C3D4', 1, 0, NOW() + INTERVAL 5 MIN,  NOW() - INTERVAL 1 MIN),
('CAPTCHA-TKT-002-E5F6G7H8', 2, 1, NOW() + INTERVAL 5 MIN,  NOW() - INTERVAL 2 HOUR),
('CAPTCHA-TKT-003-I9J0K1L2', 2, 0, NOW() + INTERVAL 5 MIN,  NOW() - INTERVAL 3 MIN),
('CAPTCHA-TKT-004-M3N4O5P6', 1, 1, NOW() - INTERVAL 1 DAY,   NOW() - INTERVAL 20 DAY),
('CAPTCHA-TKT-005-Q7R8S9T0', 4, 0, NOW() + INTERVAL 5 MIN,  NOW() - INTERVAL 1 MIN),
('CAPTCHA-TKT-006-U1V2W3X4', 3, 0, NOW() + INTERVAL 5 MIN,  NOW() - INTERVAL 2 MIN),
...
('CAPTCHA-TKT-009-G3H4I5J6', 1, 0, NOW() + INTERVAL 5 MIN,  NOW() - INTERVAL 4 MIN),
...
(1,  'AT-ADMIN-001-abc123def456ghi789',              'RT-ADMIN-001-rst123uvw456xyz789',              NOW() + INTERVAL 2 HOUR,   NOW() + INTERVAL 7 DAY,  '192.168.0.1',    'Windows/Chrome',      0, NOW() - INTERVAL 10 MIN),
...
(5,  'AT-MERCHANT04-005-def901ghi234jkl567',         'RT-MERCHANT04-005-mno890pqr123stu456',         NOW() + INTERVAL 2 HOUR,   NOW() + INTERVAL 7 DAY,  '10.10.0.5',      'Android/Chrome',      0, NOW() - INTERVAL 30 MIN),
...
(8,  'AT-MERCHANT07-008-mno890pqr123stu456',         'RT-MERCHANT07-008-vwx789yza012bcd345',         NOW() + INTERVAL 2 HOUR,   NOW() + INTERVAL 7 DAY,  '172.20.0.8',     'Windows/Firefox',     0, NOW() - INTERVAL 45 MIN),
...
(10, 'AT-OPERADMIN-010-stu456vwx789yza012',          'RT-OPERADMIN-010-bcd345efg678hij901',          NOW() + INTERVAL 2 HOUR,   NOW() + INTERVAL 7 DAY,  '192.168.0.1',    'Windows/Chrome',      0, NOW() - INTERVAL 10 MIN);

-- ============================================================
-- 14. t_commission_config — 返佣配置表（追加6条，含初始4条共10条）
--     status: 1-启用, 2-停用 | 初始4条已由 schema.sql 插入
-- ============================================================
...
(0.01,    999999.99, 0.0200, 9, 2, NOW() - INTERVAL 30 DAY, NOW()),   -- 停用的特殊费率
(0.01,    100000.00, 0.0025, 10,2, NOW() - INTERVAL 60 DAY, NOW());    -- 停用的旧费率
